export const levels = [
  {
    name: "f j",
    texts: [
      "Fj Jf Ffjffjffj Jjfjjfjjf Ffjffj Ffjffj Jjfjjf Jjfjjf Ffjffjffj Jjfjjfjjf",
      "jjf ffj Jffjffjff f Fjjfj jff Fjffjj Jfjffj fj FFjfFjf J jjff FjjfjFj fj JfjjfJf"
    ]
  },
  {
    name: "d k",
  ...
  {
    name: "s l",
    texts: ["slsl lsls ls Ls ls Ls", "sl Ls Sl SL lS"]
  },
  {
    name: "s d f j k l",
    texts: [
